...
public class DataModelController extends BaseController {
    ...
    @ResponseBody
    public ResponseData update(HttpServletRequest request,@RequestBody List<DataModel> dms){
        IRequest requestCtx = createRequestContext(request);
        return new ResponseData(dataModelService.batchUpdate(requestCtx, dms));
    }
